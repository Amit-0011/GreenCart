...
const Cart = () => {
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70  h-[70vh]">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {addresses.map((address, index)=>(
                                    <p onClick={() => {setSelectedAddress(address); setShowAddress(false)}} key={index} className="text-gray-500 p-2 hover:bg-gray-100">
...
// time stamp will we 09:36:04 stripe integration for online orders